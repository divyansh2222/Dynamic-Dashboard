...
export default function SignIn() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center dark:bg-darkbackground w-full md:w-1/2 bg-gray-100 p-8">
      <img
      ...
      <p className="text-sm md:text-base text-gray-600 dark:text-white text-center">
        Sign in to continue and explore amazing features.
      </p>
    </div>
  
    {/* Right Side: Form */}
    <div className="flex items-center justify-center dark:bg-slate-800 w-full md:w-1/2 bg-white p-8">
      <div className="w-full max-w-md shadow-md bg-slate-200 p-8 rounded-lg">
        <h2 className="text-xl md:text-2xl font-semibold mb-6 dark:text-black">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-4 sm:gap-2 py-2 mb-4 bg-red-500 text-white rounded-lg shadow-md hover:bg-red-600 transition"
        >
          <FaGoogle />
